...
/**
 * <p>
 * Java class for ASA__MetadataLog__c complex type.
 * 
 * <p>
 ...
 *         &lt;element name="ASA__SourceOrganizationURL__c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "ASA__MetadataLog__c", propOrder = { "asaactionC","asaBaseOrgIdC",
		"asaBaseOrgRefreshTokenC", "asaBaseOrgTokenC", "asaBaseOrgUrlC",
		"asaidc", "asaOrganizationIdC", "asaRecordIdC",
		"asaSourceOrgRefreshTokenC", "asaSourceOrgTokenC",
		"asaSourceOrganizationURLC", "asaTargetOrgTokenNonEncryptedC",
		"asaTargetOrgTokenC" })
public class ASAMetadataLogC extends SObject {
	...
	/**
	 * Gets the value of the asaSourceOrganizationURLC property.
	 * 
	 * @return possible object is {@link JAXBElement }{@code <}{@link String }
	 *         {@code >}
	 * 
	...
	/**
	 * Sets the value of the asaSourceOrganizationURLC property.
	 * 
	 * @param value
	 *            allowed object is {@link JAXBElement }{@code <}{@link String }
	 *            {@code >}
