...
public class ObjectFactory {
    ...
    private final static QName _ASAMetadataLogCASANameC_QNAME = new QName("urn:sobject.enterprise.soap.sforce.com", "ASA__Name__c");
    private final static QName _ASAMetadataLogCASAStatusC_QNAME = new QName("urn:sobject.enterprise.soap.sforce.com", "ASA__Status__c");
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sobject.enterprise.soap.sforce.com", name = "ASA__TargetOrgRefreshToken__c", scope = ASAMetadataLogC.class)
    public JAXBElement<String> createASAMetadataLogCASATargetOrgRefreshTokenC(String value) {
        return new JAXBElement<String>(_ASAMetadataLogCASATargetOrgRefreshTokenC_QNAME, String.class, ASAMetadataLogC.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sobject.enterprise.soap.sforce.com", name = "ASA__Name__c", scope = ASAMetadataLogC.class)
    public JAXBElement<String> createASAMetadataLogCASANameC(String value) {
        return new JAXBElement<String>(_ASAMetadataLogCASANameC_QNAME, String.class, ASAMetadataLogC.class, value);
    }
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link String }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "urn:sobject.enterprise.soap.sforce.com", name = "ASA__Status__c", scope = ASAMetadataLogC.class)
    public JAXBElement<String> createASAMetadataLogCASAStatusC(String value) {
        return new JAXBElement<String>(_ASAMetadataLogCASAStatusC_QNAME, String.class, ASAMetadataLogC.class, value);
    }
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link String }{@code >}}
     * 
