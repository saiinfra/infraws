...
public class Notifications {
    ...
    protected List<ASAMetadataLogCNotification> notification;
     ...
     * {@link ASAMetadataLogCNotification }
     * 
     * 
     */
    public List<ASAMetadataLogCNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<ASAMetadataLogCNotification>();
        }
