...
public class ReleasePackageDAO implements ISFBaseDAO {
	...
	public boolean insert(Object obj, SFoAuthHandle sfHandle) {
		...
		ASA__ReleasePackage__c[] record = new ASA__ReleasePackage__c[1];
		try {
			// Get the name of the sObject
			ASA__ReleasePackage__c a = new ASA__ReleasePackage__c();
			a.setId(relDO.getId());
			a.setName(relDO.getName());
			a.setASA__Order__c(relDO.getOrder());
			a.setASA__Package__c(relDO.getPackageC());
			a.setASA__Release__c(relDO.getReleaseC());
			record[0] = a;
