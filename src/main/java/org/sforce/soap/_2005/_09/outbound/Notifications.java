 ...
 *         &lt;element name="Notification" type="{http://soap.sforce.com/2005/09/outbound}ASAClient__MetadataLogInformation__cNotification" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Notifications {
    ...
    protected List<ASAClientMetadataLogInformationCNotification> notification;
     ...
     * 
     */
    public List<ASAClientMetadataLogInformationCNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<ASAClientMetadataLogInformationCNotification>();
        }
